...
Here we provide tables showing the locations of Phytophthora~host interactions currently listed within our database, along with the pertinent number of records. Only interactions for key Phytophthora species are shown.
...
ru_num <- read.csv("data/ru_number.csv", stringsAsFactors = FALSE)
ru_num <- nrow(ru_num)
